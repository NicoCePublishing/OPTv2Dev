(function (factory) {
        ...
        series: [
          {
            ...
            name: 'Total',
            data:  [
              1020, 1160, 1300, 958, 1240, 1020, 1409, 1200, 1051, 1120, 1240, 700
            ],
  ...
  const basicBarChartInit2 = () => {
    const { getColor, getData } = window.phoenix.utils;
    const $chartEl2 = document.querySelector('.echart-basic-bar-chart-example2');
    const months = [
      'January',
      'February',
      'March',
    ...
    if ($chartEl2) {
      const userOptions2 = getData($chartEl, 'echarts');
      ...
      echartSetOption(chart2, userOptions2, getDefaultOptions2);
    }
  };
