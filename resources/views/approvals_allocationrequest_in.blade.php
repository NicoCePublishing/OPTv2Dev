...
@section('title') Approvals Alloc. In Request @endsection
                    ...
                    <div class="d-inline"> 
                       <h4 class="mt-0 fw-bolder ms-0">
                          <a class="fw-bold fs--1 ms-3 mx-2" href="{{route('approvals')}}"> 
                            ...
                            <span class="text-500"> For {{ session('rank')}} Approval  - </span> Allocation Transfer Request - In - {{ $fname}}
            ...
            <div class="card border-0 p-2" >  
                <div class="" style="height:50vh; max-height:350vh;min-width:70vh;overflow-y:auto;overflow-x:hidden;">              
                    <div class="ms-n1 ps-1">
                        ...
                        <table id="for-approval-allocreq-table" class="fs--1 table  table-responsive text-center">
                            <thead class="border border-1 sticky-top">
                                <tr>
                                    ...
                                    <th width="10%">Requested<br>Qty</th>
                                    {{-- <th width="15%">Status</th> --}}
                                    <th scope="col" class="text-center" width="3%">
                                        <div class="d-flex ">
                                            <input class="form-check-input for_approval_allocreqin_checkallisbn" type="checkbox" value="">
                                        </div>
                                    </th>
                                 </tr>
                            </thead>
...
function for_approval_allocreq_details(docnum){

$.ajax({
       url:"/datatable_for_approval_allocreq_details?docnum="+docnum, 
       type:'GET',
       headers: {
       ...
       beforeSend: function() {
        ...
        //   $('#for-approval-finalreq-list-table tbody tr').empty()
            ...
            showLoadingDiv('#for-approval-allocreq-table');
            
       },
       success:function(data){
            $('#for-approval-allocreq-table tbody tr').empty()
        //    console.log(data);
            var data = data;
      
            hideLoadingDiv('#for-approval-allocreq-table');
            let aa = '';
            var total = 0;
            ...
            // <td class="text-center">${alloctype}</td>
                $('#for-approval-allocreq-table tbody').append(aa)
...
$(document).ready(function () {
    ...
    for_approval_allocreq_details(docnum)


    $(document).on('click','.btn-approve',function (e) {

        var forapprovalallocreqcheckbox = $('.for_approval_allocreqin_checkisbn:checked');
        ...
        var idArray = [];
        forapprovalallocreqcheckbox.each(function () {
        ...
        swal({
            ...
            .then((willCancel) => {
                ...
                if (willCancel) {
                    ...
                    $.ajax({
                            url:"/submit_approve_allocreqin?docnum="+docnum, 
                            data: {
                                ids : idArray,
                            },
                            type:'POST',
    ...
    $(document).on('click','.for_approval_allocreqin_checkallisbn',function (e) {

   
        var checkallocreqisbn= $('.for_approval_allocreqin_checkisbn') 
