...
<html>
<head>
    <title>For Approval - Final Requirements</title>
    <style>
        body {
    ...
    <table style="border-collapse: collapse; width: 100%; margin-bottom:600px;" width="100%">
        <thead>
            ...
            <tr style="line-height: 0.3;">
                <th colspan="{{ $colspan }}" style="text-align:left" >
                    ...
                    <h1><strong>Finalize Requirement Adjustment</strong></h1>
                    <h3>For Approval</h3>
                    <h4><strong>{{ projection_period_display($projdocnum) }}</strong></h4>
                    <h4>Date Printed: {{ formatDate($date_now) ?:'-' }}</h4>
                </th>
            </tr>
            ...
            <tr style="text-align: center;">
                ...
                <th scope="col" style="width: 29%; border:1px solid" width="30%">Title</th>
                <th scope="col" style="width: 5%; border:1px solid" width="5%">Total<br>Projtn</th>
                <th scope="col" style="width: 5%; border:1px solid" width="5%">SOH</th>
                ...
                <th scope="col" style="width: 7%; border:1px solid" width="5%">Adj.<br>Stock</th>
                <th scope="col" style="width: 7%; border:1px solid" width="5%">Req.</th>
        ...
        @foreach($qfinalreqd as $c)
            ...
            @php
                ...
                $descriptiontruncate = truncatelimitWords($description,32) ;
